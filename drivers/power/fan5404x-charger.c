...
{
	printk("fan5404x_charger_probe started...0\n");
	int rc;
	struct fan5404x_chg *chip;
	struct power_supply *usb_psy;
	uint8_t reg;
	...
	printk("fan5404x_charger_probe started...1\n");
	...
	printk("fan5404x_charger_probe started...2\n");
	...
	printk("fan5404x_charger_probe started...3\n");
	...
	printk("fan5404x_charger_probe started...4\n");
	...
	printk("fan5404x_charger_probe started...5\n");
	...
	printk("fan5404x_charger_probe started...6\n");
	...
	printk("fan5404x_charger_probe started...7\n");
	...
	printk("fan5404x_charger_probe started...8\n");
	...
	printk("fan5404x_charger_probe started...9\n");

	fan5404x_hw_init(chip);
	printk("fan5404x_charger_probe started...10\n");

	determine_initial_status(chip);
	printk("fan5404x_charger_probe started...11\n");
	...
	printk("fan5404x_charger_probe started...14\n");
	...
	printk("fan5404x_charger_probe started...15\n");

	fan5404x_chg_stat_handler(client->irq, chip);
	printk("fan5404x_charger_probe started...16\n");

	rc = register_reboot_notifier(&chip->notifier);
	printk("fan5404x_charger_probe started...17\n");
	if (rc)
	...
	printk("fan5404x_charger_probe started...18\n");

	schedule_delayed_work(&chip->heartbeat_work,
				msecs_to_jiffies(60000));
	printk("fan5404x_charger_probe started...19\n");

	dev_dbg(&client->dev, "FAN5404X batt=%d usb=%d done=%d\n",
			chip->batt_present, chip->usb_present,
			chip->chg_done_batt_full);
	printk("fan5404x_charger_probe started...20\n");

	return 0;

unregister_batt_psy:
	printk("fan5404x_charger_probe started...[unregister_batt_psy]\n");
